#!/usr/bin/env python3
"""Run ONE problem of brokenmath through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one brokenmath problem via TrustedRouter")
